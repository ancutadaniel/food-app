...
const controllerBookmark = (recipe)=>{
    // Add/remove bookmark
    !recipe.bookmarked ? _model.addBookmark(recipe) : _model.removeBookmark(recipe.id);
    // Update recipe view
    (0, _recipeViewDefault.default).update(_model.state.recipe);
    // Render bookmarks
...
const controlAddRecipe = async (recipe)=>{
    try {
        ...
        await _model.uploadRecipe(recipe);
        // Render Recipe
        (0, _recipeViewDefault.default).render(_model.state.recipe);
        // Render success
...
const init = ()=>{
    (0, _bookmarksViewDefault.default).addHandlerRender(controllerRenderBookmarks);
    (0, _recipeViewDefault.default).addHandlerRender(controlRecipes);
    (0, _recipeViewDefault.default).addHandlerUpdateServings(controllerServings);
    (0, _recipeViewDefault.default).addHandlerBookmark(controllerBookmark);
    (0, _searchViewDefault.default).addHandlerSearch(controllerSearch);
    (0, _paginationViewDefault.default).addHandlerPagination(controllerPagination);
...
const getSearchResultsPage = (page = state.search.page)=>{
    ...
    const end = page * (0, _config.RES_PER_PAGE); // 9;
...
const persistData = ()=>localStorage.setItem("bookmarks", JSON.stringify(state.bookmarks));
const init = ()=>{
    const getBookmarks = JSON.parse(localStorage.getItem("bookmarks"));
    if (getBookmarks) state.bookmarks = getBookmarks;
};
init();
const uploadRecipe = async (newRecipe)=>{
    try {
        // Transform data
        const ingredients = Object.entries(newRecipe).filter((el)=>el.at(0).startsWith("ingredient") && el.at(1) !== "").map((ing)=>{
            const ingArray = ing.at(1).split(",").map((el)=>el.trim());
            if (ingArray.length !== 3) throw new Error(`Wrong ingredient format, please use correct format ⛔️`);
...
parcelHelpers.export(exports, "ERROR_MSG", ()=>ERROR_MSG);
...
const ERROR_MSG = `We couldn't find that recipe. Please try another one! 💥💥💥💥💥💥`;
const RES_PER_PAGE = 10;
const API_KEY = "71040903-bc82-4fc5-bbde-bd9111e547f3";
...
const AJAX = async (url, uploadData)=>{
    try {
        const fetchMethods = uploadData ? fetch(url, {
            method: "POST",
            headers: {
...
},{"../js/config":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"l60JC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    _generateMarkupIngredient(el) {
        return `<li class="recipe__ingredient">
              ...
              <div class="recipe__quantity">${el.quantity ? (0, _fractyDefault.default)(el.quantity) : ""}</div>
    ...
    // Publisher subscriber pattern - here we pass controller function as callback
    addHandlerRender(subscriberHandlerFct) {
        [
            "hashchange",
            "load"
        ].forEach((event)=>{
            window.addEventListener(event, subscriberHandlerFct);
        });
    }
    addHandlerUpdateServings(subscriberFct) {
        this._parentEL.addEventListener("click", (e)=>{
            const btn = e.target.closest(".btn--update-servings");
            if (!btn || +btn.dataset.update === 0) return;
            subscriberFct(+btn.dataset.update);
        });
    }
    addHandlerBookmark(subscriberFct) {
        this._parentEL.addEventListener("click", (e)=>{
            const btn = e.target.closest(".btn--bookmark");
            if (!btn) return;
            subscriberFct(this._data);
        });
    }
}
exports.default = new RecipeView();

},{"./View":"5cUXS","url:../../img/icons.svg":"loVOp","fracty":"hJO4d","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5cUXS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg"); // Parcel 2
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
class View {
    _data;
    _errorMessage = (0, _config.ERROR_MSG);
    /**
   ...
   */ render(data, render = true) {
    ...
    update(data) {
        ...
        newElements.forEach((newEl, i)=>{
            ...
            if (!newEl.isEqualNode(currentEL)) // loop over attributes
...
},{"url:../../img/icons.svg":"loVOp","../config":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"loVOp":[function(require,module,exports) {
...
class SearchView {
    ...
    addHandlerSearch(subscriberFct) {
...
class ResultsView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        return this._data.map((bookmark)=>(0, _previewDefault.default).render(bookmark, false)).join("");
    }
}
exports.default = new ResultsView();

},{"./Preview":"4VK1n","./View":"5cUXS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4VK1n":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        const numPages = Math.ceil(this._data.results.length / (0, _config.RES_PER_PAGE));
...
},{"url:../../img/icons.svg":"loVOp","../config":"k5Hzs","./View":"5cUXS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4Lqzq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./View":"5cUXS","./Preview":"4VK1n","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i6DNj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./View":"5cUXS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fA0o9","aenu9"], "aenu9", "parcelRequire11e5")
